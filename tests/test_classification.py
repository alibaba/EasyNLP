...
class TestClassification(unittest.TestCase):
    def test_0_train(self):
        ...
        self.assertTrue(
            './classification_model/model.ckpt.data-00000-of-00001')
        self.assertTrue('./classification_model/model.ckpt.index')
        self.assertTrue('./classification_model/model.ckpt.meta')
