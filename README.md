...
# Vote
We are planning to integrate a few SOTA pretrained models. Please let us know which one are you interested in? [SOTA pretrained models](https://github.com/alibaba/EasyNLP/discussions/86)
