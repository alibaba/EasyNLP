...
class SwitchTransformersSparseMLP_noisegate(nn.Module):  # 每个任务对应一个expert
    r"""
    Implementation of the Switch Transformers Sparse MLP module.
    """

    def __init__(self, config: T5Config, expert_class: nn.Module = T5DenseGatedActDense):
        super().__init__()
        # Step 1: Get the correct router according to its class
        # Step 2: Get the experts
        print("MLP_type:SwitchTransformersSparseMLP_noisegate")
...
class T5LayerFF1(nn.Module):
    def __init__(self, config: T5Config):
        ...
        self.mlp = SwitchTransformersSparseMLP_noisegate(config)   
        '''
        mlp_type:
        SwitchTransformersSparseMLP
        SwitchTransformersSparseMLP_StableWeight
        SwitchTransformersSparseMLP_noisegate
        SwitchTransformersSparseMLP_averageweights
        SwitchTransformersSparseMLP_sharemoe
        SwitchTransformersSparseMLP_sharemoe2
        SwitchTransformersSparseMLP_sharemoe3
        SwitchTransformersSparseMLP_averagesoftmaxt
        SwitchTransformersSparseMLP_noisegatev3
        SwitchTransformersSparseMLP_noisegatev2
        SwitchTransformersSparseMLP_lineargate
        SwitchTransformersSparseMLP_gatenetwork
        '''
        self.layer_norm = T5LayerNorm(config.d_model, eps=config.layer_norm_epsilon)
        self.dropout = nn.Dropout(config.dropout_rate)
