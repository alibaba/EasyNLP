...
from .prompt import PromptSpell
from easynlp.modelzoo.mg_utils.utils import print_rank_0
from .mpu_transformer import GPT2ParallelTransformer, LayerNorm
...
class EncoderDecoder(torch.nn.Module):
    ...
    def __init__(self,
        ...
        # Transformer
        self.encoder = GPT2ParallelTransformer(num_layers,
                                               hidden_size,
                                               num_attention_heads,
                                               max_sequence_length,
                                               max_memory_length,
                                               ...
                                               checkpoint_activations,
                                               checkpoint_num_layers)
        self.decoder = GPT2ParallelTransformer(num_layers,
                                               hidden_size,
                                               num_attention_heads,
                                               max_sequence_length,
                                               max_memory_length,
