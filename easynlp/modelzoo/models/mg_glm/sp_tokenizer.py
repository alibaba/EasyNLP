...
if 'chinese_sentencepiece' not in os.listdir('./'):
    os.system('wget https://atp-modelzoo-sh.oss-cn-shanghai.aliyuncs.com/release/easynlp_modelzoo/public/mg/chinese_sentencepiece.zip')
    os.system('unzip -o chinese_sentencepiece.zip && rm -rf chinese_sentencepiece.zip*')
