...
class LatentDiffusionModel(DDPM):
    ...
    def __init__(self,
        ...
        self.instantiate_cond_stage(cond_stage_config,cond_stage_model)
    ...
    def instantiate_first_stage(self, config,_model):
        self.first_stage_model = _model.eval()
        self.first_stage_model.train = disabled_train
        for param in self.first_stage_model.parameters():
            param.requires_grad = False

    def instantiate_cond_stage(self, config,_model):
