...
_import_structure = {
    "configuration_kbert": ["KBertConfig"],
    "tokenization_kbert": ["KBasicTokenizer", "KBertTokenizer", "WordpieceTokenizer"],
}

if is_tokenizers_available():
    _import_structure["tokenization_kbert_fast"] = ["KBertTokenizerFast"]
