...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', default='test',# required=True,
                        help='training or testing of MatchSum', type=str)

    # parser.add_argument('--save_path',default='D:\model\matchSum',# required=True,
    parser.add_argument('--save_path',default='/home/moming/model/matchsum_paraphrase_qqp/10%/2022-09-12-16-46-32',# required=True,
                        help='root of the model', type=str)
    # example for gpus input: '0,1,2,3'
    parser.add_argument('--gpus', default='3',#required=True,
   #parser.add_argument('--gpus', default='0',#required=True,
    ...
    parser.add_argument('--candidate_num', default=56,
    ...
    # parser.add_argument('--margin', default=0.001,
