...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path',default='', required=True,
                        help='root of the model', type=str)
    parser.add_argument('--data_path',default='', required=True,
                        help='root of the model', type=str)
    parser.add_argument('--gpus', default='-1',required=True,
    ...
    parser.add_argument('--candidate_num', default=15,
    ...
    parser.add_argument('--warmup_steps', default=6000,
    ...
    parser.add_argument('--restore_from', default='', required=True,
