...
def get_data_path(mode, encoder, data_path):
    ...
    if mode == 'train':
        ...
        paths['train'] = os.path.join(data_path, 'efl_train_XSUM_' + encoder + '.jsonl')
        #paths['train']   = '/root/moming/data/disco/test_CNNDM_' + encoder + '.jsonl'
        paths['val']   = os.path.join(data_path, 'efl_test_XSUM_' + encoder + '.jsonl')
    else:
        paths['test']  = os.path.join(data_path, 'efl_test_XSUM_' + encoder + '.jsonl')
    return paths
