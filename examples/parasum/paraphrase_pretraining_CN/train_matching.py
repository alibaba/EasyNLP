...
def train_model(args):
    ...
    data_paths = get_data_path(args.mode, args.encoder, args.data_path)
    ...
    trainer = Trainer(train_data=train_set, model=model, optimizer=optimizer,
                      ...
                      metric_key='f1_score', validate_every=args.valid_steps,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path',default='/home/moming/model/matchsum_paraphrase_qqp/cnewsum_1w',# required=True,
                        help='root of the model', type=str)
    parser.add_argument('--data_path',default='/mnt/nas/moming/data/parasum/lcqmc/1w',# required=True,
                        help='root of the model', type=str)
    parser.add_argument('--gpus', default='2',#required=True,
    ...
    parser.add_argument('--candidate_num', default=1,
    ...
    parser.add_argument('--warmup_steps', default=7500,
    ...
    #parser.add_argument('--valid_steps', default=1,
