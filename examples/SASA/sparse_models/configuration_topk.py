...
""" BigBird models configuration """

from easynlp.modelzoo.configuration_utils import PretrainedConfig
import logging
...
class TopkConfig(PretrainedConfig):
    r"""

    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50358):
            Vocabulary size of the BigBird models. Defines the number of different tokens that can be represented by the
        ...
        max_position_embeddings (:obj:`int`, `optional`, defaults to 4096):
            The maximum sequence length that this models might ever be used with. Typically set this to something large
        ...
        use_cache (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not the models should return the last key/values attentions (not used by all models). Only
