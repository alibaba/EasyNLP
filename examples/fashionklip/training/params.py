...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="For jsonl-like file of fashion base, with concepts with their predicted images."
    )
    parser.add_argument(
        "--txt-id-filename",
        type=str,
        default=None,
        help="For jsonl-like file fashion concepts, with concepts with their ids."
    )
    parser.add_argument(
        "--kb-txt-id-filename",
        type=str,
        default=None,
        help="For jsonl-like file icbu concepts, with concepts with their ids."
    )
    parser.add_argument(
        "--img-data",
        type=str,
        default=None,
        help="Path to concept images npz file",
    )
    parser.add_argument(
        "--img-data-sets",
        action='append',
        default=None,
        help="Path to a set of concept images npz files",
    )
    parser.add_argument(
        "--concept-data",
        type=str,
        default=None,
        help="Path to jsonl file with concept queries",
    )
    parser.add_argument(
        "--kb-concept-data",
        type=str,
        default=None,
        help="Path to jsonl file with knowledge base concept queries",
    )
    parser.add_argument(
        "--top-k",
        type=int,
        default=10,
        help="k predictions for each concept",
    )
    parser.add_argument(
        "--logs",
        type=str,
    ...
    parser.add_argument(
        "--eval-batch-size", type=int, default=256, help="Batch size per GPU."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Augmented with Fashion KB.",
    )
    parser.add_argument(
        "--is-data-concept",
        default=False,
        action='store_true',
        help="Augmented with dataset specific Fashion KB.",
    )
    parser.add_argument(
        "--is-update",
        default=False,
        action='store_true',
        help="Update concept-image prediction by epoch.",
    )
    parser.add_argument(
        "--is-finetune-only",
        default=False,
