...
from easynlp.appzoo.image2text_generation.data import CLIPGPTImageTextDataset
from easynlp.appzoo.image2text_generation.model import CLIPGPTImageTextGeneration
from easynlp.appzoo.image2text_generation.evaluator import ImageTextGenerationEvaluator
from easynlp.appzoo.image2text_generation.predictor import CLIPGPTImageTextGenerationPredictor
...
if __name__ == "__main__":
    ...
    if args.mode == "predict":
        predictor = CLIPGPTImageTextGenerationPredictor(model_dir=args.checkpoint_dir, model_cls=CLIPGPTImageTextGeneration,
    ...
    train_dataset = CLIPGPTImageTextDataset(
    ...
    valid_dataset = CLIPGPTImageTextDataset(
        pretrained_model_name_or_path=pretrained_model_name_or_path,
    ...
    model = CLIPGPTImageTextGeneration(pretrained_model_name_or_path=pretrained_model_name_or_path, user_defined_parameters=user_defined_parameters)
