...
y1_axis_data = [44.76, 47.31, 48.12, 49.73, 51.10]
y2_axis_data = [48.31, 51.58, 55.61, 59.53, 62.06]
...
# plt.title("image classification (FGVC)", fontsize = 20)
plt.title("Visual Entailment", fontsize = 25)
plt.tick_params(labelsize=13)
plt.xticks(x_axis_data, fontsize=13)
# plt.xticks(x_axis_data, fontsize=13)
# plt.show()
