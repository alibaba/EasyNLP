...
def run_tip_adapter(clip_model, clss_head, train_loader, test_loader, max_epoch = 100, lr=5e-7):
...
def contrastive_loss(image_features, hypo_feature, idx, temp):
    ...
    contrastive_loss = (loss_i2t + loss_t2i) / 2 #+ i2t_contr_loss * 10 + t2i_contr_loss * 10
