...
def build_cache_model(cfg, clip_model, train_loader_cache, textual_feat):
    ...
    if cfg['load_cache'] == False:    
        ...
        mix_feat = fusion_feat(textual_feat, cache_keys) #torch.cat([textual_feat, cache_keys], dim=-1)
        clss_head = []
    ...
    return cache_keys.to(device_id), cache_values.to(device_id), clss_head.cuda(device_id)
