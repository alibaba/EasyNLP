...
from main_itm import fusion_feat
import clip
...
def pre_load_features(cfg, split, clip_model, loader):
    ...
    if cfg['load_pre_feat'] == False:
        ...
        torch.save(features.cpu(), cfg['cache_dir'] + "/img" + split + "_feature.pt")
        torch.save(textual_feature.cpu(), cfg['cache_dir'] + "/txt" + split + "_feature.pt")
        ...
        features = torch.load(cfg['cache_dir'] + "/img" + split + "_feature.pt")
        textual_feature = torch.load(cfg['cache_dir'] + "/txt" + split + "_feature.pt")
        ...
        #     layers.append(layer.to(device_id))
    return features.to(device_id), textual_feature.to(device_id), labels.to(device_id)
