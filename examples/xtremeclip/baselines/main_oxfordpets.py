...
def get_arguments():
    ...
    parser.add_argument('--config', default='/home/moming/code/VITCLIP/configs/oxford_pets.yaml', dest='config', help='settings of Tip-Adapter in yaml format')
...
def run_tip_adapter_F(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights,
    ...
    # Search Hyperparameters
    best_beta, best_alpha = search_hp(cfg, cache_keys, cache_values, val_features.to(device_id), val_labels.to(device_id), clip_weights,
                                      adapter=adapter)
...
def main():
    ...
    # ------------------------------------------ Tip-Adapter-F ------------------------------------------
    run_tip_adapter_F(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights,
                      clip_model, train_loader_F)
