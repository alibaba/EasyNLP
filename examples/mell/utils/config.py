...
# See the License for the specific language cgoverning permissions and
...
def add_basic_argument():
    ...
    basic_group.add_argument("--tables",
                             default='/apsarapangu/disk3/zhangtaolin.ztl/MeLL_pytorch/data/',
                             type=str,
                             required=True,
    ...
    basic_group.add_argument("--checkpoint_dir", "--checkpoint_path",
                               default='/apsarapangu/disk3/zhangtaolin.ztl/MeLL_pytorch/checkpoint/final',
                               type=str,
                               help="The model checkpoint dir.")
    basic_group.add_argument("--pretrain_model_name_or_path",
                               default="/apsarapangu/disk3/zhangtaolin.ztl/plm_dir/bert-base-cased",
                               type=str,
                               required=True,
...
def add_mtl_argument(parser):
    ...
    mtl_group.add_argument("--max_task_num", type=int, default=100,
                           help='Maximum number of tasks.')
    mtl_group.add_argument("--max_label_num", type=int, default=12,
