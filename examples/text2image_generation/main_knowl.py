...
from easynlp.appzoo import TextImageKnowlDataset
from easynlp.appzoo import TextImageGeneration_knowl
from easynlp.appzoo import TextImageGenerationEvaluator
from easynlp.appzoo import TextImageGenerationKnowlPredictor
...
if __name__ == "__main__":
    ...
    if args.mode == "predict":
        predictor = TextImageGenerationKnowlPredictor(model_dir=args.checkpoint_dir, model_cls=TextImageGeneration_knowl,
    ...
    train_dataset = TextImageKnowlDataset(
    ...
    valid_dataset = TextImageKnowlDataset(
        pretrained_model_name_or_path=pretrained_model_name_or_path,
    ...
    model = TextImageGeneration_knowl(pretrained_model_name_or_path=pretrained_model_name_or_path, user_defined_parameters=user_defined_parameters)
