...
from easynlp.appzoo.video2text_generation.data import CLIPGPTFrameTextDataset
from easynlp.appzoo.video2text_generation.model import CLIPGPTFrameTextGeneration
from easynlp.appzoo.video2text_generation.evaluator import FrameTextGenerationEvaluator
from easynlp.appzoo.video2text_generation.predictor import CLIPGPTFrameTextGenerationPredictor
...
if __name__ == "__main__":
    ...
    if args.mode == "predict":
        predictor = CLIPGPTFrameTextGenerationPredictor(model_dir=args.checkpoint_dir, model_cls=CLIPGPTFrameTextGeneration,
    ...
    train_dataset = CLIPGPTFrameTextDataset(
    ...
    valid_dataset = CLIPGPTFrameTextDataset(
        pretrained_model_name_or_path=pretrained_model_name_or_path,
    ...
    model = CLIPGPTFrameTextGeneration(pretrained_model_name_or_path=pretrained_model_name_or_path, user_defined_parameters=user_defined_parameters)
    evaluator = FrameTextGenerationEvaluator(valid_dataset=valid_dataset, user_defined_parameters=user_defined_parameters)
